...
import { passkeyNewFormSchema, PasskeyNewFormValues } from '@/lib/zod/schemas';

export default function PasskeyNewForm() {
  const [isDialogOpen, setIsDialogOpen] = useState<boolean>(false);
  const [isLoading, setIsLoading] = useState<boolean>(false);
  const router = useRouter();
  const form = useForm<PasskeyNewFormValues>({
    resolver: zodResolver(passkeyNewFormSchema),
    defaultValues: {
      name: '',
    },
  });
